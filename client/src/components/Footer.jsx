      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="animate-fade-in-up">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">Premium home-care products for a cleaner, fresher home. Powerful cleaning, brilliant shine, trusted every day.</p>
          ...
          <div className="animate-fade-in-up animate-delay-100">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link to="/about" className="text-gray-400 hover:text-highlight-400 transition-colors flex items-center"><span className="mr-2 text-highlight-500">›</span>About S CUBE</Link></li>
              ...
              <li><Link to="/track-order" className="text-gray-400 hover:text-highlight-400 transition-colors flex items-center"><span className="mr-2 text-highlight-500">›</span>Track Order</Link></li>
          ...
          <div className="animate-fade-in-up animate-delay-200">
            ...
            <ul className="space-y-2.5 text-sm">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">04322 222646</span>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center text-sm">
          ...
          <div className="flex items-center space-x-4 mt-3 sm:mt-0">
            ...
            <span className="text-gray-700">|</span>
            <Link to="/track-order" className="text-gray-500 hover:text-gray-300 transition-colors">Track Order</Link>
            <span className="text-gray-700">|</span>
